...
\begin{exo} 
	...
	\begin{enumerate}
		...
		%%
		\item En utilisant que $X_n$ a la même loi que la somme de $n$ v.a. i.i.d. de loi de Poisson de paramètre $1$, ainsi que le théorème central limite, déterminer la limite de la suite $(u_n)_{n\geq 0}$.
	\end{enumerate}
\end{exo}
...
%%
\item Comme $X_n$ a la même loi que $P_1+\ldots+P_n$, où $(P_k)_{k\geq1}$ est une suite de v.a. i.i.d. de loi de Poisson de paramètre $1$, on a
\[
...
\[
\frac{a \sigma}{\sqrt{n}} \leq \varepsilon
\quad \Leftrightarrow \quad
