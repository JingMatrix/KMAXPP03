...
\begin{exo} On tire un point $(X,Y)$ au hasard dans le disque unité de $\R^2$.
	\begin{enumerate}
...
\begin{exo} 
	...
	Montrer que les événements $A_1,\dots,A_n$ sont indépendants si et seulement si les v.a. $\1_{A_1},\dots\1_{A_n}$ sont indépendantes.
\end{exo}
