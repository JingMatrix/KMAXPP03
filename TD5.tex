...
\begin{comment}
    \begin{enumerate}
        ...
        \[
            p_{(X,Y)}(x,y) 
            = \frac{1}{4\pi} (1+2x)(2+y)e^{-(x^2+y^2)/2}
            = \left( \frac{1}{4\pi} (1+2x)e^{-x^2/2} \right) 
            \left( (2+y)e^{-y^2/2} \right).
        \]
        ...
        \[
        \int_\R (1+2x)e^{-x^2/2} \diff x 
        = \int_\R e^{-x^2/2} \diff x + \int_\R 2xe^{-x^2/2} \diff x
        = \sqrt{2 \pi} + 0,
        \]
        où l'on a utilisé dans la 2ème intégrale que la fonction intégrée est impaire.
        On en déduit que la factorisation normalisée est
        \[
            p_{(X,Y)}(x,y) 
            = \left( \frac{1}{\sqrt{2 \pi}} (1+2x)e^{-x^2/2} \right) 
            \left( \frac{1}{2\sqrt{2 \pi}}(2+y)e^{-y^2/2} \right).
        \]
        Donc les densités de $X$ et $Y$ sont
        \[
            p_X(x) 
            = \frac{1}{\sqrt{2 \pi}} (1+2x)e^{-x^2/2} 
            \qquad \text{et} \qquad 
            p_Y(y) = \frac{1}{2\sqrt{2 \pi}}(2+y)e^{-y^2/2}.
        \]
        %%
